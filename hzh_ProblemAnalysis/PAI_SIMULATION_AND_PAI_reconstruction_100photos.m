...
% 光声成像重建图像存放地址
rec_dir = '..\DataSet\Skin Cancer MNIST 100 Rec Photos\50_sensor_points';
%% 3.获取想要的文件夹信息
% 读取文件夹内所有图片的路径
...
% =========================================================================
    ...
    % 5.定义具有num_sensor_points个传感器元件的中心圆的笛卡尔传感器掩模
...
% =========================================================================
    ...
    % 2.将重建后的图片进行保存
    imwrite(I_cut,fullfile(rec_dir,[imgdir(i).name(1:end-4),'.jpg']))
